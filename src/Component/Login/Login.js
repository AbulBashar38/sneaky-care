                ...
                <div className="col-md-7 my-auto p-5">
                    <form>
                        ...
                        <div className='text-center'>
                            <button className="btn btn-custom btn-google" onClick={handleGoogleLogin}><FontAwesomeIcon className="icon" icon={faGoogle} /> Login with Google</button>
                        </div>
                        <div className="mb-3 form-check">
                            <input type="checkbox" onChange={() => setShowAdmin(!showAdmin)} className="form-check-input" id="exampleCheck1" />
                            <label className="form-check-label" htmlFor="exampleCheck1">Check me out if you are an Admin</label>
                        </div>
                    </form>
                </div>
